...
from backend.services.recommendation_engine import generate_jd_recommendations
...
def analyze_full_resume(
    ...
    logger.info(f"Parsed candidate name: {parsed_resume.get('name', '')!r}")
    ...
    jd_recommendations = generate_jd_recommendations(jd_comparison_result)
    ...
    return {
        ...
        "jd_recommendations": jd_recommendations,
